...
@Component({
  ...
  template: `
    <main class="mx-auto max-w-7xl p-8">
      ...
      <!-- Page header -->
      <section class="rounded-2xl bg-[#032D42] px-6 py-5 text-white shadow-sm">
        <p
        ...
        <h1 class="mt-1 text-2xl font-bold tracking-tight">Resources</h1>
              ...
              <form class="space-y-8 p-6" (ngSubmit)="saveResource()">
                ...
                <section class="border-t border-gray-200 pt-7">
                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      <label for="costDescription" class="block text-sm font-medium text-gray-700">
                        Cost description
                      </label>
                  ...
                  <div class="space-y-5">
                    ...
                    <div class="grid gap-3 sm:grid-cols-2">
                      ...
                      >
                        ...
                        <span>
                          <span class="block text-sm font-semibold text-gray-900"> Verified </span>
                      ...
                      >
                        ...
                        <span>
                          <span class="block text-sm font-semibold text-gray-900"> Featured </span>
